...
LRESULT CALLBACK WndProc(HWND hwnd, UINT iMsg, WPARAM wParam, LPARAM lParam) {
	...
	switch (iMsg) {
	case WM_CREATE:									// Window Create								// Create Window
	...
	case WM_LBUTTONDOWN:							// Mouse Left Button								// Mouse Left botton pressed
		wsprintf(str, TEXT("WM_LeftButtonDown is Arrived"));
		MessageBox(hwnd, str, TEXT("MESSAGE..."), MB_OK | MB_ICONINFORMATION);
		break;

	case WM_DESTROY:							// Window Distroy									// close Application
		PostQuitMessage(0);
		break;
	}
