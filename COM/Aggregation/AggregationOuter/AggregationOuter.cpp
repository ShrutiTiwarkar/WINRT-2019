...
HRESULT CSumSubtract::InitializeInnerComponent(void) {
	...
	if (FAILED(hr)) {
		MessageBox(NULL, TEXT("Inner Component IUnknown Interface Cannot Be Found"), TEXT("Error"), MB_OK);
		return(E_FAIL);
	}
	...
	if (FAILED(hr)) {
		MessageBox(NULL, TEXT("Inner Component IMultiplicationInterface Cannot Be Found"), TEXT("Error"), MB_OK);
		m_pIUnkownInner->Release();
		m_pIUnkownInner = NULL;
		return(E_FAIL);
	}
	...
	if (FAILED(hr)) {
		MessageBox(NULL, TEXT("Inner Component IDivision Interface Cannot Be Found "), TEXT("Error"), MB_OK);
...
HRESULT CSumSubtractClassFactory::CreateInstance(IUnknown *pUnkOuter, REFIID riid, void **ppv) {
	...
	if (FAILED(hr)) {
		...
		MessageBox(NULL, TEXT("Inner Component Failed to Initailize "), TEXT("ERROR"), MB_OK);
